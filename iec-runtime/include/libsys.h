...
inline void sfun_rcmode_read(IValue *reg_base) {
    // TODO
    reg_base->v.value_i = rc_shm->rc_mode;
}

inline void sfun_rcplc_servoflag_set(IValue *reg_base){
    // TODO
    rc_shm->servo_poweron_flag = reg_base->v.value_i;
    reg_base->v.value_i = rc_shm->interp_startup_flag;
    // printf("interp_startup_flag: %d\n", rc_shm->interp_startup_flag);
}

inline void sfun_servo_poweron(IValue *reg_base) {
    // TODO
    sv_shm->ctrl_area.control_word = 1;
    reg_base->v.value_i = sv_shm->ctrl_area.status_word;
}

inline void sfun_servo_poweroff(IValue *reg_base) {
    // TODO
    sv_shm->ctrl_area.control_word = 0;
...
static const SPOUDesc spou_desc[] = {
    ...
    {"SFUN_RCPLC_SERVOFLAG_SET", 1, 1, sfun_rcplc_servoflag_set},
